...
import ru.lexender.project.server.description.FormOfEducation;
...
public class StudyGroupBuilder extends ObjectBuilder implements StorageObjectBuilder {
    ...
    public StorageObject<StudyGroup> build(List<String> arguments, Invoker invoker) throws ObjectBuilderException {
    ...
    public StorageObject<StudyGroup> buildInLine(List<String> arguments, Invoker invoker) throws ObjectBuilderException {
